...
(() => {
  ...
  const emphasizeResult=()=>{const target=$('gnss-status-target');if(!target)return;target.classList.add('has-result');window.setTimeout(()=>scrollToTarget('gnss-status-target','center',0),80);};
