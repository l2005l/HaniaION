const CACHE_NAME = "haniaion-mission-v44";
const APP_SHELL = ["/", "/wind", "/static/style.css?v=44", "/static/app.js?v=44", "/static/wind.css?v=44", "/static/wind.js?v=44", "/static/icons/icon.svg", "/manifest.webmanifest"];
