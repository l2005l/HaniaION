const CACHE_NAME = "haniaion-v2.6.0";
const APP_SHELL = ["/", "/wind", "/satellite", "/static/style.css?v=51", "/static/app.js?v=51", "/static/wind.css?v=45", "/static/wind.js?v=45", "/static/satellite.css?v=3", "/static/satellite.js?v=3", "/static/data-status.css?v=4", "/static/data-status.js?v=4", "/static/icons/icon.svg", "/manifest.webmanifest"];
