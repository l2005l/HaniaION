const CACHE_NAME = "haniaion-v1-final-20260805";
const APP_SHELL = ["/", "/wind", "/static/style.css?v=40", "/static/app.js?v=40", "/static/wind.css?v=40", "/static/wind.js?v=40", "/static/icons/icon.svg", "/manifest.webmanifest"];
