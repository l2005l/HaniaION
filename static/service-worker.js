const CACHE_NAME = "haniaion-mission-v46";
const APP_SHELL = ["/", "/wind", "/satellite", "/static/style.css?v=45", "/static/app.js?v=45", "/static/wind.css?v=45", "/static/wind.js?v=45", "/static/satellite.css?v=1", "/static/satellite.js?v=1", "/static/icons/icon.svg", "/manifest.webmanifest"];
