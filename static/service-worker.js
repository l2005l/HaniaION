const CACHE_NAME = "haniaion-mission-v45";
const APP_SHELL = ["/", "/wind", "/static/style.css?v=45", "/static/app.js?v=45", "/static/wind.css?v=45", "/static/wind.js?v=45", "/static/icons/icon.svg", "/manifest.webmanifest"];
